...
-- CREANDO TRIGGERS
CREATE OR REPLACE TRIGGER TRG_SOLICITUDES BEFORE INSERT ON USERS
 FOR EACH ROW
 BEGIN
...
CREATE OR REPLACE TRIGGER TRG_CLIENTES BEFORE INSERT ON USERS
 FOR EACH ROW
 BEGIN
...
CREATE OR REPLACE TRIGGER TRG_INFO_SOLICITUD BEFORE INSERT ON USERS
 FOR EACH ROW
 BEGIN
...
CREATE OR REPLACE TRIGGER TRG_NOTIFICACIONES BEFORE INSERT ON USERS
 FOR EACH ROW
 BEGIN
...
CREATE OR REPLACE TRIGGER TRG_TIPO_DOCUMENTO BEFORE INSERT ON USERS
 FOR EACH ROW
 BEGIN
...
CREATE OR REPLACE TRIGGER TRG_TIPO_NOTIFICACION BEFORE INSERT ON USERS
 FOR EACH ROW
 BEGIN
...
INSERT INTO T05_TIPO_DOCUMENTO (DESC_TIPO_NOTIFICACION) VALUES ('TARJETA DE IDENTIDAD');
INSERT INTO T05_TIPO_DOCUMENTO (DESC_TIPO_NOTIFICACION) VALUES ('CEDULA');
INSERT INTO T05_TIPO_DOCUMENTO (DESC_TIPO_NOTIFICACION) VALUES ('CEDULA EXTRANJERIA');
INSERT INTO T05_TIPO_DOCUMENTO (DESC_TIPO_NOTIFICACION) VALUES ('PASAPORTE');
INSERT INTO T05_TIPO_DOCUMENTO (DESC_TIPO_NOTIFICACION) VALUES ('REGISTRO CIVIL');
